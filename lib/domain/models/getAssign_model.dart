...
GetAssignModel getAssignModelFromJson(String str) => GetAssignModel.fromJson(json.decode(str));
...
class GetAssignModel {
    ...
    factory GetAssignModel.fromJson(Map<String, dynamic> json) => GetAssignModel(
        ...
        data: json["Data"] == null ? [] : List<GetAssignDatum>.from(json["Data"]!.map((x) => GetAssignDatum.fromJson(x))),
        status: json["Status"],
